...
export function ValidationReceipt() {
  ...
  const handleSubmit = async (e) => {
    ...
    toast.promise(
      axios.post(`${import.meta.env.VITE_API_URL}/api/uploadreceiptprevia/`, formData, {
          headers: {
      ...
      let filename = 'Validation_Report.xlsx'; // Nombre por defecto
  ...
  return (
    <div style={{marginTop:20, marginLeft:30}}>
      <Toaster />
      <p className='title' style={{marginBottom:10}}>Validador de Recibos Previa</p>
      <p style={{fontSize:18, fontWeight:'bold'}}>Insertar plantilla para validar recibo. </p>
